                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li class="mx-0 mx-lg-1"><a class="dropdown-item py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<?php echo e(route('AdminArticulos.index')); ?>">Administrador</a></li>
                            <?php endif; ?>
        ...
        <section class="page-section" id="avatar-nombre">
             <div id="perfil" class="masthead bg-secondary text-white text-center">
                <div class="container d-flex align-items-center flex-column justify-content-center">
                    ...
                    <!-- Masthead Heading-->
                    <h1 class="masthead-heading"><?php echo e($user->name); ?></h1><br><br><br>
                </div>
            </div>
        </section>
     ...
     <div class="container">
         ...
         <div class="row">
             <div class="d-flex justify-content-center w-100">
              <p class="lead text-center"><?php echo e($user->description); ?></p>
          </div>
      </div>
  </div>
</section>
...
</html><?php /**PATH C:\laragon\www\WildTech\resources\views/profile.blade.php ENDPATH**/ ?>