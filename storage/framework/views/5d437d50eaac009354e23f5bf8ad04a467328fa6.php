...
<section class="page-section" id="crear-articulo">
	<div id="register" class="form">
		...
		<div class="register-page">
			<form method="POST" action="<?php echo e(route('AdminArticulos.store')); ?>" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
				...
				<input name="author_id" value="<?php echo e(Auth::user()->id); ?>" class="d-none">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\WildTech\resources\views/admin/articulos/create.blade.php ENDPATH**/ ?>