...
<body id="page-top">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li class="mx-3 mx-lg-2">
                          <a class="dropdown-item py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<?php echo e(route('show.edit', Auth::user()->id)); ?>">Mi perfil</a>
                        </li>
   ...
   <!-- AQUÍ VA UN CARROUSEL CON ALGUNAS FOTOS QUE ENTRAN EN LA TEMÁTICA DEL BLOG -->
    ...
    <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
			  <div class="carousel-item active" data-interval="2000">
				<img src="<?php echo e(asset('img/carousel-welcome-1.jpg')); ?>" class="d-block w-100" alt="...">
			  </div>
			  <div class="carousel-item" data-interval="2000">
				<img src="<?php echo e(asset('img/carousel-welcome-2.jpg')); ?>" class="d-block w-100" alt="...">
			  </div>
			  <div class="carousel-item">
				<img src="<?php echo e(asset('img/carousel-welcome-3.jpg')); ?>" class="d-block w-100" alt="...">
			  </div>
			</div>
    ...
    <section class="portfolio d-flex mt-4 mb-4 flex-wrap justify-content-center">
        <?php $__currentLoopData = $recientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
            <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2 text-muted text-center">Autor: <a class="card-link" href="<?php echo e(route('show.edit',$articulo->author_id)); ?>"><?php echo e($articulo->author_name); ?></a></h6><br>
                ...
                <a href="<?php echo e(route('show.show', $articulo->id)); ?>" class="card-link">Ver más</a>
              </div>
            </div>
          </div>
        </div>
...
<?php /**PATH C:\laragon\www\WildTech\resources\views/welcome.blade.php ENDPATH**/ ?>