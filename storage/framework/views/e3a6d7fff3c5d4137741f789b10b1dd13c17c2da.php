              ...
              <div class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto text-white">
                  <li class="nav-item mx-3 mx-lg-2">
                    <a id="a-varonil"  class="nav-link active py-3 px-2 px-lg-3 rounded js-scroll-trigger" href="<?php echo e(route('index.varonil')); ?>">Varonil</a>
                  </li>
                  <li class="nav-item mx-3 mx-lg-2">
                    <a class="nav-link active py-3 px-2 px-lg-3 rounded js-scroll-trigger" href="<?php echo e(route('index.femenil')); ?>">Femenil</a>
                  </li>
...
</html><?php /**PATH C:\laragon\www\WildTech\resources\views/layouts/app.blade.php ENDPATH**/ ?>